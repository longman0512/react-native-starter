...
import IntroNavigatorView from './introNavigation';
  ...
  return (
    <DrawerContentScrollView {...props} style={styles.drawerContent}>
      <View style={styles.avatarContainer}>
        <Image
          style={styles.avatar}
          source={require('../../../assets/images/brand/second.png')}
        />
...
export default function App() {
  ...
  return (
    ...
    >
      <Drawer.Screen name="Intro" component={IntroNavigatorView} options={{drawerLockMode: 'locked-closed', gestureEnabled: false, swipeEnabled: false }}/>
